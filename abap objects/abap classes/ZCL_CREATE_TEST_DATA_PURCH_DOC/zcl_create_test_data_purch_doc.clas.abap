...
CLASS zcl_create_test_data_purch_doc IMPLEMENTATION.
  ...
  METHOD create_purchase_documents.
    DATA: lt_purch_docs TYPE STANDARD TABLE OF z_g_pdoc.
    ...
    INSERT z_g_pdoc FROM TABLE @lt_purch_docs.
  ENDMETHOD.
 ...
 vendor = 'Doe Computers' vendortype = 'P' lchg_date_time = lv_time_stamp_utc lchg_uname = 'Marissa May'  purchasedocumentitemimageurl = './images/laptop.jpg'  )
  ...
  METHOD create_purch_doc_vendors.
    DATA: lt_purch_doc_vendor TYPE STANDARD TABLE OF zpurchvendortyp.
    ...
    INSERT zpurchvendortyp FROM TABLE @lt_purch_doc_vendor.
  ENDMETHOD.
