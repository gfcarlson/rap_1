...
public section.
  ...
  data MV_PURCHASEDOCUMENT type ZKG_PDOC .
  data MV_UNAME type SYUNAME .
  data MV_PURCHASEDOCUMENTITEM type ZKG_PDOC .
  ...
  methods CONSTRUCTOR
    importing
      ...
      !MV_PURCHASEDOCUMENT type ZKG_PDOC optional
      !MV_UNAME type SYUNAME optional
      !MV_PURCHASEDOCUMENTITEM type ZKG_PDOC optional .
protected section.
private section.
ENDCLASS.
