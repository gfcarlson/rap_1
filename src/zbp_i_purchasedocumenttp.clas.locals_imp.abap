...
CLASS lhc_PurchaseDocument IMPLEMENTATION.
  ...
  METHOD Approve_Order.
    " NOTE: table name assumed as ZTG_PDOC to match the .bdef's
    " "persistent table ztg_pdoc" clause. Please confirm in SE11 —
  ...
  METHOD Reject_Order.
    " NOTE: same table-name assumption as Approve_Order above — verify ZTG_PDOC.
